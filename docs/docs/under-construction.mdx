...
- ✅ Stars
- ✅ Emoji Popper
- Emoji Popper with multiple colors and NotoEmoji (Open Emoji as a personal recommendation https://github.com/hfg-gmuend/openmoji/blob/master/font/OpenMoji-Color.ttf)
- Flowers
