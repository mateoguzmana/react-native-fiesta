...
- Words Splash
- Flowers
- Better firework animation (The current one is very simple)
...
- Proper web support (add react-native-web to the example and check components work nicely in web)
